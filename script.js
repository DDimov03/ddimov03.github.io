document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        bg: {
            ...
            period: 'В момента',
            experienceDescription: 'Специалист по техническа поддръжка със солиден стаж в софтуер, приложения и облачни решения. Целенасочен към разрешаването на сложни технически проблеми и предоставянето на изключително обслужване на клиентите в динамична IT среда.',
            ...
            // Typing Text
            typingText: [
                'Мотивиран', 'и', 'ентусиазиран', 'професионалист',
